...
<body>
    ...
    <div class="row">
        <div class="column">
            ...
            <center><div class="information">(CE069)</div></center>
        </div>
        <div class="column">
            <center><img src="pranjal.jpg" style="border-radius: 100%;"></center>
            <center><h2>Pranjal Javia</h2><center>
            <center><div class="profession">Front-End Developer</div></center>
            <center><div class="information">(CE045)</div></center>
        </div>
        <div class="column">
            <center><img src="nilay.jpg" style="border-radius: 100%;"></center>
            <center><h2>Nilay Kansagara</h2><center>
            <center><div class="profession">Front-End Developer</div></center>
            <center><div class="information">(CE054)</div></center>
        </div>
        <div class="column">
            <center><img src="manan.jpg" style="border-radius: 100%;"></center>
            <center><h2>Manan Kadiya</h2><center>
            <center><div class="profession">Back-End Developer</div></center>
            <center><div class="information">(CE049)</div></center>
        </div>
    </div>
