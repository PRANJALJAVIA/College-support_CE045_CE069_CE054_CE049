...
<p>Please enter collage name that you want to compare with other.</p>
...
<p>Please enter collage name that you want to compare with collage - 1. </p>
<form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="get">
<select name="id">
	  <option selected="selected">-- select college name --</option>
	  <?php
	  ...
	  $result = mysqli_stmt_get_result($stmt);
        ...
        ?>
</select></br></br><input type="submit" value="Submit" name="second">
<a href="button.php">Back</a>
</form>
</div>
</div>
